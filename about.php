    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="about.php" class="nav-item nav-link active">Withdraw</a>
                <a href="service.html" class="nav-item nav-link">Invest</a>
                <a href="home.php" class="nav-item nav-link">balance</a>
                
                <a href="contact.html" class="nav-item nav-link">Contact</a>
                <a href="logout.php" class="nav-item nav-link">SignIn/SignOut</a>
            </div>
    ...
    <div class="container-fluid hero-header bg-light py-5 mb-5">
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                <div class="col-lg-6">
                    <h1 class="display-4 mb-3 animated slideInDown">WITHDRAW</h1>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100">
                        ...
                        <a class="btn btn-primary py-3 px-4" href="">CONTACT COSTOMER CARE TO MAKE WITHDRAWAL</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a href="#">INTEL INC</a>, All Right Reserved. 2017
                    </div>
